 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataTablesPage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataTablesPage';
...
'count' => 'getCount'    ];
    ...
    {
        $this->container['data_tables'] = isset($data['data_tables']) ? $data['data_tables'] : null;
    ...
    {
        return $this->container['data_tables'];
    }
     ...
     * @return $this
     */
    public function setDataTables($data_tables)
    {
        $this->container['data_tables'] = $data_tables;
