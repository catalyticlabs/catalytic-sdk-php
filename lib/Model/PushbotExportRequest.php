 ...
 *
 * @category Class
 * @description A request to create a .catalytic Pushbot Export file
 * @package  Catalytic\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PushbotExportRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets processID
     *
     * @param string|null $processID The ID of the Pushbot to export
     *
     * @return $this
     */
     ...
     * Sets password
     *
     * @param string|null $password The option password to use to secure the .catalytic Pushbot Export file
     *
     * @return $this
     */
