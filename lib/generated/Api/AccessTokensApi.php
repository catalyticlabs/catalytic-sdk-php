...
class AccessTokensApi
{
     ...
     * Create Access Token
     *
     * @param  \Catalytic\SDK\Model\AccessTokenCreationRequest $accessTokenCreationRequest Params required to create new Access Token (optional)
     *
     ...
     *
     * @param  \Catalytic\SDK\Model\AccessTokenCreationWithEmailAndPasswordRequest $accessTokenCreationWithEmailAndPasswordRequest Params required to create and approve new Access Token (optional)
     *
     * @throws \Catalytic\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Catalytic\SDK\Model\ProblemDetails|\Catalytic\SDK\Model\ProblemDetails|\Catalytic\SDK\Model\AccessToken
     ...
     * Get Access Token
     *
     * @param  string $id The ID of the Access Token to get (required)
     *
     * @throws \Catalytic\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function listAccessTokens($pageToken = null, $pageSize = null)
    {
        list($response) = $this->listAccessTokensWithHttpInfo($pageToken, $pageSize);
        return $response;
    }
     ...
     */
    public function listAccessTokensWithHttpInfo($pageToken = null, $pageSize = null)
    {
        $request = $this->listAccessTokensRequest($pageToken, $pageSize);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAccessTokensAsync($pageToken = null, $pageSize = null)
    {
        return $this->listAccessTokensAsyncWithHttpInfo($pageToken, $pageSize)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAccessTokensAsyncWithHttpInfo($pageToken = null, $pageSize = null)
    {
        $returnType = '\Catalytic\SDK\Model\AccessTokensPage';
        $request = $this->listAccessTokensRequest($pageToken, $pageSize);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listAccessTokensRequest($pageToken = null, $pageSize = null)
    {
     ...
     * Revoke Access Token
     *
     * @param  string $id The ID of the Access Token to revoke (required)
     *
     * @throws \Catalytic\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Catalytic\SDK\Model\ProblemDetails|\Catalytic\SDK\Model\ProblemDetails|\Catalytic\SDK\Model\ProblemDetails|\Catalytic\SDK\Model\AccessToken
     ...
     * Wait For Approval
     *
     * @param  \Catalytic\SDK\Model\WaitForAccessTokenApprovalRequest $waitForAccessTokenApprovalRequest Params required to poll approved Access Token (optional)
     *
     * @throws \Catalytic\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
