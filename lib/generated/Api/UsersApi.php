...
class UsersApi
{
     ...
     * @param  \Catalytic\SDK\Model\UserSearchClause $userSearchClause userSearchClause (optional)
     *
     * @throws \Catalytic\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Catalytic\SDK\Model\ProblemDetails|\Catalytic\SDK\Model\UsersPage
     */
    public function searchUsers($pageToken = null, $pageSize = null, $userSearchClause = null)
    {
        list($response) = $this->searchUsersWithHttpInfo($pageToken, $pageSize, $userSearchClause);
        return $response;
    }
     ...
     * @param  string $pageToken The token representing the result page to get (optional)
     * @param  int $pageSize The page size requested (optional)
     * @param  \Catalytic\SDK\Model\UserSearchClause $userSearchClause (optional)
     *
     * @throws \Catalytic\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function searchUsersWithHttpInfo($pageToken = null, $pageSize = null, $userSearchClause = null)
    {
        $request = $this->searchUsersRequest($pageToken, $pageSize, $userSearchClause);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchUsersAsync($pageToken = null, $pageSize = null, $userSearchClause = null)
    {
        return $this->searchUsersAsyncWithHttpInfo($pageToken, $pageSize, $userSearchClause)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchUsersAsyncWithHttpInfo($pageToken = null, $pageSize = null, $userSearchClause = null)
    {
        $returnType = '\Catalytic\SDK\Model\UsersPage';
        $request = $this->searchUsersRequest($pageToken, $pageSize, $userSearchClause);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchUsersRequest($pageToken = null, $pageSize = null, $userSearchClause = null)
    {

        $resourcePath = '/api/users/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($userSearchClause)) {
            $_tempBody = $userSearchClause;
        }
