...
/**
 * IntegrationCreationRequest Class Doc Comment
 *
 * @category Class
 * @package  Catalytic\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class IntegrationCreationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationCreationRequest';
     ...
     * Sets name
     *
     * @param string $name The display Name to apply to the  Integration
     *
     * @return $this
     */
